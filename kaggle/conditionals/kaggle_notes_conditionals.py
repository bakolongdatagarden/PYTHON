...
def conditional_statements_demo():
    ...
    def multiple_elifs():
        ...
        For instance, the next block of code calculates the dose of medication (in milliliters) to give a child, based on weight (in kilograms).
        """
        def get_dose(weight):
            ...
            if weight < 5.2:
                ...
                dose = 7.5
            # Dosage is 10ml for anyone 21.2 kg or over
            else:
                dose = 10
            return dose
            """
            Below we will run our function.
            - Once an "elif" statement evaluates to True and the code block is run, the function skips over all remaining "elif" and "else" statements.
            - After skipping these, all that is left is the return statement, which returns the value of dose.
            - The order of the elif statements does matter here. Reordering will return a very different result.
            """
        print(get_dose(12))
